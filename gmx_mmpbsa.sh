...
trj=npt-nopr.xtc		# 轨迹文件 trajectory file
tpr=npt-nopr.tpr		# tpr文件  tpr file
ndx=index.ndx		# 索引文件 index file

pro=DNA			# 蛋白索引组   index group name of protein
lig=ATP			# 配体索引组   index group name of ligand
...
module add GROMACS/2021.3-foss-2021a-CUDA-11.3.1-PLUMED-2.7.2
module add APBS/apbs-1.5

gmx='/public/software/.local/easybuild/software/GROMACS/2021.3-foss-2021a-CUDA-11.3.1-PLUMED-2.7.2/bin/gmx'								# /path/to/GMX/bin/gmx_mpi
dump="$gmx dump"						# gmx dump
trjconv="$gmx trjconv -b 40000 -e 50000 -dt 1000"			# gmx trjconv, use -b -e -dt, NOT -skip

apbs='/public/software/.local/easybuild/software/APBS/APBS-1.5-linux64/bin/apbs'				# APBS(Linux)
PATH=$PATH:/public/software/.local/easybuild/software/APBS/APBS-1.5-linux64/bin
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/public/software/.local/easybuild/software/APBS/APBS-1.5-linux64/lib    # APBS(Windows), USE "/", NOT "\"
export MCSH_HOME=energy/null				# APBS io.mc
